...
export const getBetDataAccount = (program: Program<ChartGame>, gameDataAccount: PublicKey, better: Keypair) => {
  return PublicKey.findProgramAddress(
    [
...
export const getUserEntrantsAccount = (program: Program<ChartGame>, better: Keypair) => {
  return PublicKey.findProgramAddress(
    [
...
export const getUserDataAccount = (program: Program<ChartGame>, better: Keypair) => {
  return PublicKey.findProgramAddress(
    [
